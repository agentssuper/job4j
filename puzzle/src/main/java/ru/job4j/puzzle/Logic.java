        ...
        for (int x = 0; x != table.length; x++) {
            ...
            if (result != true) {
                ...
                if (table[x][x] == 1) {
                    ...
                    //Нам в этом поможет переменная schetchik, помогающая перейти к первому элементу строки или столбца.
                    //Если в строке или столбце есть хотя бы одно значение не равное 1, что перемноженные элементы строки
                    ...
                    //Если не произошло break, это значит, либо в строке либо в столбце все
                    // элементы равны 1. А значит, result = true. Дальше проверять нет смысла. Мы выиграли.
                    //Надеюсь, моё решение задачи теперь засчитано.
                    for (int i = 0; i != table.length; i++) {
                        //Переменные pereX и pereY - это результаты перемножения элементов строки и столбца, соответственно.
                        pereX = pereX * table[x - schetchik + i][x];
                        pereY = pereY * table[x][x - schetchik + i];
                        if (pereX != 1 && pereY != 1) {
                            break;
                        }
                    }
